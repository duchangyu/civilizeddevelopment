...
{
    /// <summary>
    /// Interface for test result collecting objects.
    /// </summary>
    public interface ITestResultCollector
    {
        /// <summary>
        /// Implement to hold information about a module that
        /// failed to load.
        /// </summary>
        /// <param name="moduleName">Name of the module that failed.</param>
        /// <param name="exceptionMessage">Descriptive message about the error.</param>
        void AddModuleLoadFailure(string moduleName, string exceptionMessage);

        /// <summary>
        /// Implement to add a test class result.
        /// </summary>
        /// <param name="result">Test class result.</param>
        void AddTestClassResults(TestClassResult result);
    }
}