...
[assembly: ExtensionApplication(typeof(TinyRunner.TinyRunnerApp))]

namespace TinyRunner
{
    /// <summary>
    /// AutoCAD extension application implementation.
    /// </summary>
    public class TinyRunnerApp : IExtensionApplication
    {
