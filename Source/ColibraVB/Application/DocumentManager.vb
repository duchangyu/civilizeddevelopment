...
Namespace Colibra
    Public Class DocumentManager
        ...
        Public Shared Function OpenDocument(ByVal fileName As String) As Document
        ...
        Friend Shared Sub _activateDocument(ByVal doc As Document)
            acadappsvcs.Application.DocumentManager.MdiActiveDocument = doc._acaddoc
            m_ActiveDocument = doc
        End Sub

        Private Shared Sub createNewAndActivateFromAutoCADDocument(ByVal acadDoc As acadappsvcs.Document)
            Dim civilDoc As CivilDocument = getCivilDocumentAndActivate(acadDoc)
            m_ActiveDocument = New Document(acadDoc, civilDoc)
        End Sub

        Private Shared Function getCivilDocumentAndActivate(ByVal acadDoc As acadappsvcs.Document) As CivilDocument
