...
namespace ColibraShould
{
    ...
    public class DocumentManagerShould 
    {
        ...
        private string _SecondOpenedName 
        {
            get
            {
        ...
        private const string k_FirstTestDocumentName = "first_opened.dwg";
        private Document m_FirstOpenedDocument;
        private const string k_SecondTestDocumentName = "second_opened.dwg";
        private Document m_SecondOpenedDocument;
    }
}