...
namespace ColibraShould
{
    ...
    {
        public ByNameObjectSelectorShould()
        {
            m_SelectionDocument = DocumentManager.OpenDocument(
                _selectionDocumentName);
        }
        ...
        private string _selectionDocumentName
        {
            get
            {
        ...
        private Document m_SelectionDocument;
    }
}