...
Namespace Colibra
    ...
    ''' </summary>
    Public Class AlignmentEntitySCSSCS
        Inherits AAlignmentEntity
        Protected Overrides Sub WriteCustomInfo(writer As IAlignmentEntityInfoWriter)
            writer.WriteCurveGroupName("Spiral - Curve - Spiral - Spiral - Curve - Spiral")
        End Sub
    End Class
End Namespace